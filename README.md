...
To install [`graphql-upload`](https://npm.im/graphql-upload) and the [`graphql`](https://npm.im/graphql) peer dependency with [yarn](https://npmjs.com/get-npm), run:

```sh
yarn add graphql-upload graphql
```
